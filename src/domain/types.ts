...
export interface Player { name: string; baseId: string; }
...
export interface Actions { complete: (standId: string, actId: string) => CompleteResult; claim: (prizeId: string) => void; }
